      ...
      <div className="flex justify-between items-center px-4 py-2 dark:text-white ">
        ...
        <div className="flex items-center gap-2 border border-gray-300 dark:border-gray-600 rounded-md px-3 py-2 w-64 focus-within:ring-2 focus-within:ring-blue-500 dark:bg-[#1e1e1e]">
          ...
          <input
            ...
            placeholder="Search..."
            aria-label="Search"
            className="w-full bg-transparent focus:outline-none text-sm placeholder-gray-400 dark:placeholder-gray-500 text-black dark:text-white sm:disabled:"
        />
        </div>



        <div className="hidden md:flex text-2xl gap-4 items-center">
          <ThemeToggle />
          <FaBell className="cursor-pointer hover:text-blue-600 transition" />
          <FaUserCircle className="cursor-pointer hover:text-blue-600 transition" />
        </div>
      </div>
    </div>
